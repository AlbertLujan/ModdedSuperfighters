package com.newgrounds.components
{
   ...
   public class APIConnector extends MovieClip
   {
      ...
      [Inspectable(name="API ID",type="String")]
      ...
      [Inspectable(name="Encryption Key",type="String")]
      ...
      [Inspectable(name="Movie Version",type="String")]
      ...
      [Inspectable(name="Debug Mode",type="Boolean",defaultValue="true")]
      ...
      [Inspectable(name="Use Fake User Session",type="Boolean",defaultValue="true")]
      ...
      [Inspectable(name="Use Default Medal Popup",type="Boolean",defaultValue="true")]
      ...
      [Inspectable(name="Use Default Error Screens",type="Boolean",defaultValue="true")]
      ...
      [Inspectable(name="Show Connecting Dialog",type="Boolean",defaultValue="true")]
