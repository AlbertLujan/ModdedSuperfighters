package com.newgrounds
{
   ...
   public class Medal
   {
      ...
      {
         return Boolean(this._iconLoader) ? this._iconLoader.contentLoaderInfo.bytesLoaded : 0;
      }
      
      public function get bytesTotal() : uint
      {
         return Boolean(this._iconLoader) ? this._iconLoader.contentLoaderInfo.bytesTotal : 0;
      }
