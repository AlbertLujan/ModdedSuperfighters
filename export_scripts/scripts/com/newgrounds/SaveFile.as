package com.newgrounds
{
   ...
   public class SaveFile extends EventDispatcher
   {
      ...
      {
         return Boolean(this._loader) ? this._loader.bytesLoaded : this._contentSize;
      }
      ...
      override public function toString() : String
      {
         ...
         var _loc1_:String = "Save File " + this._filename + "   ID: " + this._id + "\n  " + this._description + "\n";
