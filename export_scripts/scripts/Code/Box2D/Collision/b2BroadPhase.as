package Code.Box2D.Collision
{
   ...
   public class b2BroadPhase
   {
      ...
      private function ComputeBounds(param1:Array, param2:Array, param3:b2AABB) : void
      {
         ...
         _loc4_ = Number(b2Math.b2Min(_loc4_,m_worldAABB.upperBound.x));
         _loc5_ = Number(b2Math.b2Min(_loc5_,m_worldAABB.upperBound.y));
         _loc4_ = Number(b2Math.b2Max(_loc4_,m_worldAABB.lowerBound.x));
         _loc5_ = Number(b2Math.b2Max(_loc5_,m_worldAABB.lowerBound.y));
         _loc6_ = param3.upperBound.x;
         _loc7_ = param3.upperBound.y;
         _loc6_ = Number(b2Math.b2Min(_loc6_,m_worldAABB.upperBound.x));
         _loc7_ = Number(b2Math.b2Min(_loc7_,m_worldAABB.upperBound.y));
         _loc6_ = Number(b2Math.b2Max(_loc6_,m_worldAABB.lowerBound.x));
         _loc7_ = Number(b2Math.b2Max(_loc7_,m_worldAABB.lowerBound.y));
      ...
      public function InRange(param1:b2AABB) : Boolean
      {
         ...
         _loc2_ = Number(b2Math.b2Max(_loc2_,_loc4_));
         _loc3_ = Number(b2Math.b2Max(_loc3_,_loc5_));
