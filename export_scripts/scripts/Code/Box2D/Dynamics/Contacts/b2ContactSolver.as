         ...
         while(_loc6_ < param3)
         {
            ...
            while(_loc22_ < _loc12_)
            {
               ...
               while(_loc27_ < _loc26_.pointCount)
               {
                  ...
                  _loc40_ += _loc10_.m_invI * (_loc36_ - _loc38_ * _loc38_) + _loc11_.m_invI * (_loc37_ - _loc39_ * _loc39_);
                  _loc29_.normalMass = 1 / _loc40_;
                  _loc41_ = _loc10_.m_mass * _loc10_.m_invMass + _loc11_.m_mass * _loc11_.m_invMass;
                  _loc41_ += _loc10_.m_mass * _loc10_.m_invI * (_loc36_ - _loc38_ * _loc38_) + _loc11_.m_mass * _loc11_.m_invI * (_loc37_ - _loc39_ * _loc39_);
                  ...
                  _loc46_ += _loc10_.m_invI * (_loc36_ - _loc44_ * _loc44_) + _loc11_.m_invI * (_loc37_ - _loc45_ * _loc45_);
      ...
      public function SolvePositionConstraints(param1:Number) : Boolean
      {
         ...
         while(_loc5_ < m_constraintCount)
         {
            ...
            while(_loc20_ < _loc19_)
            {
               ...
               _loc2_ = Number(b2Math.b2Min(_loc2_,_loc33_));
      ...
      public function SolveVelocityConstraints() : void
      {
         ...
         while(_loc19_ < m_constraintCount)
         {
            ...
            while(_loc1_ < _loc37_)
            {
               ...
               _loc13_ = Number(b2Math.b2Max(_loc2_.normalImpulse + _loc11_,0));
               _loc11_ = _loc13_ - _loc2_.normalImpulse;
               _loc38_ = _loc35_ * _loc2_.normalImpulse;
               _loc14_ = Number(b2Math.b2Clamp(_loc2_.tangentImpulse + _loc12_,-_loc38_,_loc38_));
