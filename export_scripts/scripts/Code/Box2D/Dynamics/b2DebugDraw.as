package Code.Box2D.Dynamics
{
   ...
   public class b2DebugDraw
   {
      ...
      {
         var _loc4_:int = 0;
         m_sprite.graphics.lineStyle(m_lineThickness,param3.color,m_alpha,false,"none");
      ...
      {
         m_sprite.graphics.lineStyle(m_lineThickness,16711680,m_alpha,false,"none");
         ...
         m_sprite.graphics.lineStyle(m_lineThickness,65280,m_alpha,false,"none");
         m_sprite.graphics.moveTo(param1.position.x * m_drawScale,param1.position.y * m_drawScale);
      ...
      {
         m_sprite.graphics.lineStyle(m_lineThickness,param4.color,m_alpha,false,"none");
