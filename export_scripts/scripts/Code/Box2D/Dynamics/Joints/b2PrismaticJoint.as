package Code.Box2D.Dynamics.Joints
{
   ...
   public class b2PrismaticJoint extends b2Joint
   {
      ...
      override public function SolvePositionConstraints() : Boolean
      {
         ...
         _loc23_ = Number(b2Math.b2Clamp(_loc23_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection));
         ...
         _loc25_ = Number(b2Math.b2Abs(_loc23_));
         _loc26_ = _loc4_.m_sweep.a - _loc3_.m_sweep.a - m_refAngle;
         _loc26_ = Number(b2Math.b2Clamp(_loc26_,-b2Settings.b2_maxAngularCorrection,b2Settings.b2_maxAngularCorrection));
         ...
         _loc28_ = Number(b2Math.b2Abs(_loc26_));
         if(m_enableLimit && m_limitState != e_inactiveLimit)
         {
            ...
            {
               _loc1_ = Number(b2Math.b2Clamp(_loc31_,-b2Settings.b2_maxLinearCorrection,b2Settings.b2_maxLinearCorrection));
               _loc32_ = -m_motorMass * _loc1_;
               _loc25_ = Number(b2Math.b2Max(_loc25_,b2Math.b2Abs(_loc26_)));
            }
            else if(m_limitState == e_atLowerLimit)
            {
               _loc1_ = _loc31_ - m_lowerTranslation;
               _loc25_ = Number(b2Math.b2Max(_loc25_,-_loc1_));
               _loc1_ = Number(b2Math.b2Clamp(_loc1_ + b2Settings.b2_linearSlop,-b2Settings.b2_maxLinearCorrection,0));
               _loc32_ = -m_motorMass * _loc1_;
            ...
            else if(m_limitState == e_atUpperLimit)
            {
               ...
               _loc25_ = Number(b2Math.b2Max(_loc25_,_loc1_));
               _loc1_ = Number(b2Math.b2Clamp(_loc1_ - b2Settings.b2_linearSlop,0,b2Settings.b2_maxLinearCorrection));
               _loc32_ = -m_motorMass * _loc1_;
               _loc2_ = m_limitPositionImpulse;
