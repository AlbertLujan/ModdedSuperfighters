   ...
   public class b2RevoluteJoint extends b2Joint
   {
      ...
      override public function SolvePositionConstraints() : Boolean
      {
         ...
         if(m_enableLimit && m_limitState != e_inactiveLimit)
         {
            ...
            {
               _loc2_ = Number(b2Math.b2Clamp(_loc25_,-b2Settings.b2_maxAngularCorrection,b2Settings.b2_maxAngularCorrection));
               _loc26_ = -m_motorMass * _loc2_;
               _loc24_ = Number(b2Math.b2Abs(_loc2_));
            }
            else if(m_limitState == e_atLowerLimit)
            {
               _loc2_ = _loc25_ - m_lowerAngle;
               _loc24_ = Number(b2Math.b2Max(0,-_loc2_));
               _loc2_ = Number(b2Math.b2Clamp(_loc2_ + b2Settings.b2_angularSlop,-b2Settings.b2_maxAngularCorrection,0));
               _loc26_ = -m_motorMass * _loc2_;
            ...
            else if(m_limitState == e_atUpperLimit)
            {
               ...
               _loc24_ = Number(b2Math.b2Max(0,_loc2_));
               _loc2_ = Number(b2Math.b2Clamp(_loc2_ - b2Settings.b2_angularSlop,0,b2Settings.b2_maxAngularCorrection));
               _loc26_ = -m_motorMass * _loc2_;
               _loc1_ = m_limitPositionImpulse;
