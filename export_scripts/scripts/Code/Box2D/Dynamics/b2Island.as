package Code.Box2D.Dynamics
{
   ...
   public class b2Island
   {
      ...
      public function b2Island(param1:int, param2:int, param3:int, param4:*, param5:b2ContactListener, param6:Function)
      {
         var _loc7_:int = 0;
         m_fallasleepbody = function(param1:b2Body):void
         {
         };
         super();
            ...
            while(_loc5_ < m_bodyCount)
            {
               ...
               if(_loc6_.m_invMass != 0)
               {
                  ...
                  else
                  {
                     ...
                     _loc13_ = Number(b2Math.b2Min(_loc13_,_loc6_.m_sleepTime));
                  }
               }
               _loc5_++;
            }
